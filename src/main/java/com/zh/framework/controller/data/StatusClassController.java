 ...
 */
@Controller
@RequestMapping("/data/statusClass")
public class StatusClassController extends BaseController<TbStatusClass> {

    @ResponseBody
    @RequestMapping(value = "getList.do", method = RequestMethod.POST)
    public String getList() {
        String json = super.getGrid(null, "statusClaName", "asc", 1, 10);
    ...
    public String getClassList() {
        ...
        list.addAll(service.findSelectData(param,0,0,"statusClaName","id"));
        httpEntity.setObj(list);
        return tojson(httpEntity);
    }

    @Override
    public String saveBody(@RequestBody TbStatusClass t) {
        int result=0;
