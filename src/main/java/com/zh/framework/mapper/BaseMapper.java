...
import com.zh.framework.annotation.MyBatistaXmlDao;
...
public interface BaseMapper<T> {
    ...
    @DeleteProvider(type = BaseSql.class,method = "deleleBatch")
    public int deleleBatch(@Param("ids") String ids, Class<T> t);
    ...
    public List<T> findTreeGridByParams(@Param("params") Map<String, Object> params,@Param("parentColumn")String parentColumn, final Class<T> t);
}