...
//                    break;
    ...
    /**
     * @param params key->value key field_symbol  demo(username_EQ)查询用户名等于 value
     * @param t
     * @return
     */
    public String findParamTreeGridSQL(@Param("params") Map<String, Object> params, @Param("parentColumn") String parentColumn, final Class<T> t) {
        SQL sql = new SQL();
